...
const ProductDisplay = () => {
    ...
    const [DisDesLen, SetDisDesLen] = useState(400)
    const [DisSpeLen, SetSpeLen] = useState(200)
    const [DisDes, SetDisDes] = useState(false)
    const [DisSpe, SetDesSpe] = useState(false)
                    ...
                    {data && data.slice(0, 1).map((Data2) => {
                        ...
                        return (
                            <>
                                ...
                                <div className=' col-md-7 col-lg-8  mt-2 ' style={{ height: '100vh', marginBottom: '30px', overflow: 'auto', scrollbarWidth: 'none' }}>
                                    <h6>
                                    ...
                                    <div className='mt-2 ml mb-2 d-flex row justify-content-' style={{}}>
                                        {Data2.Product_Name.Hightlet && <>
                                            ...
                                            <div className='ml-auto mr-auto'>
                                                {Highlets}
                                                {Data2.Product_Name.Hightlet.length > 100 && <><span>Read</span></>}
                                            </div>
                                        </>}
                                    </div>
                                    <div className='mt-2 mb-2 d-flex flex-column' style={{ border: '2px solid gray' }}>
                                        {Data2.Product_Name.Description && <>
                                            ...
                                            {/* <span className='col-12 d-flex flex-row mt-2' style={{ textWrap: 'wrap' }}><small className='ml-3 mr-3' style={{ color: 'gray', fontWeight: 'bolder' }}>descritption</small>{reactElements}</span> */}
